...
const G = struct {
    ...
    fn glyph(g: *G, ic: Icon) void {
        ...
        switch (ic) {
            ...
            .corrupt_ent => {
                g.trap(0, -0.22, 0.36, 0.44, 0.56, col);
                g.bar(-0.16, -0.14, -0.56, -0.34, 0.15, col);
                g.bar(0.16, -0.14, 0.56, -0.26, 0.15, col);
                g.hbar(0, 0.42, 0.60, 0.13, col);
                g.tri(-0.36, 0.34, -0.12, 0.34, -0.26, 0.60, col);
                g.tri(0.12, 0.34, 0.36, 0.34, 0.26, 0.60, col);
                g.vbar(-0.14, -0.36, 0.24, 0.07, col);
                g.vbar(0.14, -0.34, 0.22, 0.07, col);
                g.disc(-0.14, -0.51, 0.09, col);
                g.disc(0.14, -0.48, 0.09, col);
