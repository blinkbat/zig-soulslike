...
fn dial(ctx: *ui.Ctx, x: i32, y: i32, w: i32, t: usize, r: usize, c: usize) bool {
    ...
    var moved = false;
    // THE COLUMN'S OWN `lo`..`hi` AS A BAR: the readout beside it scrubs a step at a time, and a table whose only coarse gesture is 6 px a step is a table nobody sweeps.
