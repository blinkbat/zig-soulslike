...
// FP buys CASTS now (`combat.BOLT_FP`, off the wand), so Mind is how many of them a grace is worth — the curve was written for the day sorcery landed and this is that day. Mind's caps are ~35/50/60.
