...
pub const swing_light = Event{ .low = 0.08, .high = 0.20, .dur = 0.06 };
pub const swing_heavy = Event{ .low = 0.30, .high = 0.34, .dur = 0.13 };
pub const hit_light = Event{ .low = 0.22, .high = 0.42, .dur = 0.10 };
pub const hit_heavy = Event{ .low = 0.48, .high = 0.60, .dur = 0.17 };
pub const hurt = Event{ .low = 0.55, .high = 0.32, .dur = 0.22 };
pub const hurt_heavy = Event{ .low = 0.90, .high = 0.45, .dur = 0.34 };
...
pub const kill = Event{ .low = 0.34, .high = 0.20, .dur = 0.14 };
pub const death = Event{ .low = 1.00, .high = 0.60, .dur = 0.70 };
